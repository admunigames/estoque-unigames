...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .unigames-emblem{position:relative;display:grid;place-items:center;width:min(270px,58%);aspect-ratio:418/374;border-radius:31%;background:#fff;box-shadow:0 30px 75px rgba(0,0,0,.34),0 0 54px rgba(102,217,255,.19);animation:logoFloat 5.5s ease-in-out infinite}
    .unigames-emblem::before{content:"";position:absolute;inset:-12px;border:1px solid rgba(102,217,255,.22);border-radius:31%;box-shadow:0 0 34px rgba(102,217,255,.11);animation:pulseRing 3.4s ease-out infinite}
    .unigames-emblem img{display:block;width:100%;height:100%;object-fit:contain;border-radius:31%}
    ...
    @media(max-width:860px){body{padding:20px}.login-shell{width:min(520px,100%);grid-template-columns:1fr;min-height:0}.command-panel{min-height:270px;padding:24px;border-right:0;border-bottom:1px solid rgba(125,210,255,.15)}.hero-logo{min-height:220px}.unigames-emblem{width:136px}.system-stats{display:none}.tech-core{width:230px;height:230px;left:50%;top:50%}.tech-ring.mid{inset:32px}.tech-ring.inner{inset:70px}.core-light{inset:88px}.auth-zone{padding:25px}.auth-card{width:100%;animation:none}}
    @media(max-width:520px){body{align-items:start;padding:13px}.login-shell{margin:8px 0;border-radius:24px;animation:none}.command-panel{min-height:225px;padding:20px}.hero-logo{min-height:185px}.unigames-emblem{width:116px}.tech-core{left:50%;top:50%;width:185px;height:185px}.tech-ring.mid{inset:27px}.tech-ring.inner{inset:58px}.core-light{inset:72px}.auth-zone{padding:14px}.auth-card{padding:25px 20px;border-radius:20px}.auth-card::before{border-radius:20px}.auth-card h2{font-size:26px}.orb.one{width:220px;height:220px}.orb.two{width:150px;height:150px}}
