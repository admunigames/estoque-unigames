...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    @media(max-width:860px){body{padding:20px}.login-shell{width:min(520px,100%);grid-template-columns:1fr;min-height:0}.command-panel{min-height:270px;padding:24px;border-right:0;border-bottom:1px solid rgba(125,210,255,.15)}.hero-logo{min-height:220px}.unigames-emblem{width:168px;padding:14px;border-radius:26px}.unigames-emblem::before{border-radius:34px}.system-stats{display:none}.tech-core{width:230px;height:230px;left:50%;top:50%}.tech-ring.mid{inset:32px}.tech-ring.inner{inset:70px}.core-light{inset:88px}.auth-zone{padding:25px}.auth-card{width:100%;animation:none}}
